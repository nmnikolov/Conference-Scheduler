...
<form action="" class="form-horizontal" method="post" role="form">
    ...
    <div class="form-group col-md-7">
        ...
        <div class="input-group col-md-9">
            <input class="form-control input-group" id="title" name="title" type="text" value="<?= $model->getTitle(); ?>" readonly>
        </div>
    </div>
    <div class="form-group col-md-7">
        <label class="col-md-3 control-label" for="description">Description</label>
        <div class="col-md-9 input-group">
            <textarea id="description" class="form-control" rows="5" name="description" readonly><?= $model->getDescription(); ?></textarea>
        </div>
    </div>
    <div class="form-group col-md-7">
        ...
        <div id="start-time-picker" class="input-group col-md-9 date date-input date-picker">
            <input class="form-control" id="start-time" name="startTime" value="<?= $model->getStartTime(); ?>" type="datetime" readonly>
    ...
    <div class="form-group col-md-7">
        ...
        <div id="end-time-picker" class="input-group col-md-9 date date-input date-picker">
            <input class="form-control" id="end-time" name="endTime" type="datetime" value="<?= $model->getEndTime(); ?>" readonly>
            <div class="input-group-addon">
                <span class="datepicker-icon">
                    <span class="glyphicon glyphicon-calendar"></span>
                </span>
    ...
    <div class="form-group  col-md-7">
        <div class="col-md-offset-2 col-md-10">
            ...
            <a class="btn btn-default" href="<?= \Framework\Helpers\Helpers::url() . "conferences/edit/" . $model->getId(); ?>">Cancel</a>
        </div>
    </div>
</form>