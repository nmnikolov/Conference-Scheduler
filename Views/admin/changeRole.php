...
<form action="<?= \Framework\Helpers\Helpers::url() . "admin/users/" . $model->getUser()->getId() . "/role/editPst"?>" class="form-horizontal" method="post" role="form">
    <hr>
    <input type="hidden" name="redirect" value="<?= "admin/users/" . $model->getUser()->getId() . "/role/edit" ?>">
    <div class="form-group col-md-7">
        <label class="col-md-3 control-label" for="username">Username</label>
        <div class="col-md-9">
            <input class="form-control input-group" id="username" type="text" value="<?= $model->getUser()->getUsername() ?>" readonly>
        </div>
    </div>
    <div class="form-group col-md-7">
        <label class="col-md-3 control-label" for="fullname">Fullname</label>
        <div class="col-md-9">
            <input class="form-control input-group" id="fullname" type="text" value="<?= $model->getUser()->getFullName() ?>" readonly>
        </div>
    </div>
    <div class="form-group col-md-7">
        <label class="col-md-3 control-label" for="current-role">Current role</label>
        <div class="col-md-9">
            <input class="form-control input-group" id="current-role" type="text" value="<?= $model->getRole()->getName() ?>" readonly>
        </div>
    </div>
    <div class="form-group col-md-7">
